...
$sql = "SELECT * FROM profiles WHERE id=2";
...
<table style="border:1px solid black;">
    ...
    ?>
        ...
        <tr>
            ...
            <td style="border:1px solid black; width: 100px; text-align: center;"><?php echo $row["kryptonite"];?><td>
...
<?php 
$sql = "UPDATE profiles SET kryptonite = 51 WHERE id = 2";
?>

<input id="button" type="submit" name="button" value="LIKE THIS PROFILE" onclick="myFunction(<?php $sql ="UPDATE profiles
SET kryptonite = kryptonite + 1
WHERE id = 2;" ?>);"/>